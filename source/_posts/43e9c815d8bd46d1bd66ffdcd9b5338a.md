...
<img width="16" height="16" src=":/2316c72842084ecd9e0541e244a483cd"/> [GitHub](https://github.com/rxliuli/joplin-utils/releases/tag/joplin-publisher%401.0.0)

<img width="130" height="65" src=":/ed345f022a4646a583cf6c4e10d78695"/>
...
2. Use the template project [joplin-blog-template](https://github.com/joplin-utils/joplin-blog-template) as a template to create a new repository named `<github username>.github.io`<img width="650" height="464" src=":/75aa0a2832074e0eb47566c331ede4dc"/>\ <img width="650" height="464" src=":/2e436ef75542432cb5db7264f28d01a0"/>\ <img width="650" height="464" src=":/b0221d5c2e564f3b894cdabbcd357e63"/>

3. Modify Settings > Pages > Build and deployment, select GitHub Actions <img width="650" height="464" src=":/98934aca127442ae9b4394e8cfb99adc"/>

4. [Create](https://github.com/settings/personal-access-tokens/new) a GitHub token, at least select content and `<github username>.github.io` repository permissions, copy the token after creation <img width="650" height="464" src=":/6e7f0550042c45d496937f7f4f91e6fe"/>

### <a id="joplin-joplin-4"></a>[](#joplin-joplin-4)Joplin [​](#joplin)

1. Install the plugin

2. Open Joplin > Settings > Plugins > Publisher, and set GitHub token/username/repo respectively <img width="650" height="465" src=":/1ead11caf3e64be29ffc4d17ce6c0bf5"/>

3. Select a note and add the **blog** tag <img width="650" height="465" src=":/25b433e38c5d4b2c880c4064ffb37341"/>
...
<img width="24" height="24" src=":/1ca3d09dee3248709c79ff0dfd619adf"/> hyruo:
